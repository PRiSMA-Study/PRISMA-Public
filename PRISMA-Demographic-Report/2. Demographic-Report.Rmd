---
title: "<span style='font-size: 18px'> <span style='text-align: center'>Demographics Report"
date: "`r Sys.Date()`"
output:
  pdf_document:
    toc: no
...
knit: (function(inputFile, encoding) { 
      rmarkdown::render(inputFile,
                    encoding=encoding, 
                    output_file= paste('D:/Users/williams_pj/Documents/Analysis/Demographics/2026-05-01/output/Demographics-Report_', Sys.Date(), '.pdf', sep='')) })
---

*Demographic table is showing baseline household and individual characteristic.*

**Date of included data upload to Synapse: ** 2026-05-01

**Date report issued: **  `r Sys.Date()`
...
load(paste0("~/Analysis/Demographics/", UploadDate, "/derived_data/df_demo.RData"))
