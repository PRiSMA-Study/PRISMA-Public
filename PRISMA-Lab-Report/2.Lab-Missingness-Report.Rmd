...
```{r}
    ...
    matrix3_4 <- df_lab %>%
      ...
      summarise(
        ...
        ## NEW FOLATE ROW FOR FOLATE by RBC or Serum 
        "Missing Folate - RBC & Serum: n (%)*" = paste0(
          sum(eval(parse(text = paste0("is.na(M08_FOLATE_RBC_NMOLL_LBORRES_", num, ")", " & is.na(M08_FOLATE_PLASMA_NMOLL_LBORRES_", num, ")"))) & 
                (denom_folate_rbc_1 ==1 | denom_folate_rbc_1 ==1)),
          " (",
          format(round(sum(eval(parse(text = paste0("is.na(M08_FOLATE_RBC_NMOLL_LBORRES_", num, ")", " & is.na(M08_FOLATE_PLASMA_NMOLL_LBORRES_", num, ")")))
                           & (denom_folate_rbc_1 ==1 | denom_folate_rbc_1 ==1))/sum((denom_folate_rbc_1 ==1 | denom_folate_rbc_1 ==1), na.rm = TRUE)*100, 2), nsmall = 0, digits = 2),
          ")"),
  ...
  # if(num %in% c(1,4)) {
    matrix3_4 <- df_lab %>%
      ...
      summarise(
        ...
        "Missing Folate - RBC & Serum: n (%)*" = paste0(
         sum(eval(parse(text = paste0("is.na(M08_FOLATE_RBC_NMOLL_LBORRES_", num, ")", " & is.na(M08_FOLATE_PLASMA_NMOLL_LBORRES_", num, ")"))) & 
            (denom_folate_rbc_4 ==1 | denom_folate_rbc_4 ==1)),
              " (",
        format(round(sum(eval(parse(text = paste0("is.na(M08_FOLATE_RBC_NMOLL_LBORRES_", num, ")", " & is.na(M08_FOLATE_PLASMA_NMOLL_LBORRES_", num, ")")))
                        & (denom_folate_rbc_4 ==1 | denom_folate_rbc_4 ==1))/sum((denom_folate_rbc_4 ==1 | denom_folate_rbc_4 ==1), na.rm = TRUE)*100, 2), nsmall = 0, digits = 2),
              ")"),
  ...
  # if(num %in% c(10)) {
    matrix3_4 <- df_lab %>%
      ...
      summarise(
        ...
        "Missing Folate - RBC & Serum: n (%)*" = paste0(
         sum(eval(parse(text = paste0("is.na(M08_FOLATE_RBC_NMOLL_LBORRES_", num, ")", " & is.na(M08_FOLATE_PLASMA_NMOLL_LBORRES_", num, ")"))) & 
            (denom_folate_rbc_10 ==1 | denom_folate_rbc_10 ==1)),
              " (",
        format(round(sum(eval(parse(text = paste0("is.na(M08_FOLATE_RBC_NMOLL_LBORRES_", num, ")", " & is.na(M08_FOLATE_PLASMA_NMOLL_LBORRES_", num, ")")))
                        & (denom_folate_rbc_10 ==1 | denom_folate_rbc_10 ==1))/sum((denom_folate_rbc_10 ==1 | denom_folate_rbc_10 ==1), na.rm = TRUE)*100, 2), nsmall = 0, digits = 2),
              ")"),
