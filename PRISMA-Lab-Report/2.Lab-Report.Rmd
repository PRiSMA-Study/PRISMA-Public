---
title: "<span style='font-size: 18px'> <span style='text-align: center'> PRISMA & ReMAPP Lab Missingness Report (Issued: 2025-07-31)"
...
**Date of included data upload to Synapse: ** 2025-06-27
  ...
  #******************table 3.5*****************
   if (num %in% c(1)) {
    ...
    tb3_5 <- tb_theme2(matrix3_5) %>%
      ...
      tab_footnote(
        footnote = c("Note: thyroid testing stopped on 2024-09-01 (Ghana); 2024-10-17 (CMC); 2024-01-14 (Kenya); 2024-10-03 (Pakistan); 2024-10-11 (Zambia); ongoing (SAS).")
      ) %>%
...
tb3_7 <- tb_theme2(matrix3_7) %>%
  ...
  tab_source_note(
    source_note = c("Note: Included data with SCRN_OBSSTDAT at/after: 2022-12-28 (Ghana); 2023-06-20(CMC); 2023-12-12(SAS); 2023-04-03(Kenya); 2022-12-15(Zambia); LBSTDAT between: 2022-09-22 (Pakistan).")
  ) %>%
  tab_source_note(
...
tb3_10 <- tb_theme2(matrix3_10) %>%
 ...
 tab_stubhead(label = "Part X. Chlamydia and Gonorrhea Test Results") %>%
  ...
  tab_footnote(
    footnote = c("Kenya Note: CT/NG testing stopped 2025-02-27.")
  ) %>%
  # tab_footnote(
        ...
        "Total" = df_lab_cbc %>%
          ...
          plyr::summarise(
            ...
            "Missing Neutrophils (%): n (%)*" = paste0(
              ...
              ")"),
            "Missing Neutrophils (full cell count) : n (%)*" = paste0(
              sum(eval(parse(text = paste0("is.na(M08_CBC_NEU_FCC_LBORRES_", num, ")"))) & SITE != "Pakistan" & denom_lab_08_1 ==1, na.rm = TRUE),
              " (",
              format(round(sum(eval(parse(text = paste0("is.na(M08_CBC_NEU_FCC_LBORRES_", num, ")"))) & SITE != "Pakistan" & denom_lab_08_1 ==1, na.rm = TRUE)/sum(SITE != "Pakistan" & denom_lab_08_1 ==1, na.rm = TRUE) *100, 2), nsmall = 0, digits = 2),
              ")"),
            "Missing Lymphocyte (%): n (%)*" = paste0(
              sum(eval(parse(text = paste0("is.na(M08_CBC_LYMPH_PCT_LBORRES_", num, ")")))),
              " (",
              ...
              ")"),
            "Missing Lymphocyte (full cell count): n (%)*" = paste0(
              sum(eval(parse(text = paste0("is.na(M08_CBC_LYMPH_FCC_LBORRES_", num, ")"))) & SITE != "Pakistan" & denom_lab_08_1 ==1, na.rm = TRUE),
              " (",
              format(round(sum(eval(parse(text = paste0("is.na(M08_CBC_LYMPH_FCC_LBORRES_", num, ")"))) & SITE != "Pakistan" & denom_lab_08_1 ==1, na.rm = TRUE)/sum(SITE != "Pakistan", na.rm = TRUE)*100, 2), nsmall = 0, digits = 2),
              ")"),
            "Missing Erythrocyte Count: n (%)*" = paste0(
              sum(eval(parse(text = paste0("is.na(M08_CBC_ERYTH_MM_LBORRES_", num, ")")))),
              " (",
            ...
            "Missing Monocyte (%): n (%)*" = paste0(
              ...
              ")"),
            "Missing Monocyte (full cell count): n (%)*" = paste0(
              sum(eval(parse(text = paste0("is.na(M08_CBC_MONO_FCC_LBORRES_", num, ")"))) & SITE != "Pakistan" & denom_lab_08_1 ==1, na.rm = TRUE),
              " (",
              format(round(sum(eval(parse(text = paste0("is.na(M08_CBC_MONO_FCC_LBORRES_", num, ")"))) & SITE != "Pakistan" & denom_lab_08_1 ==1, na.rm = TRUE)/sum(SITE != "Pakistan", na.rm = TRUE)*100, 2), nsmall = 0, digits = 2),
              ")"),
            "Missing Eosinophils (%): n (%)*" = paste0(
              sum(eval(parse(text = paste0("is.na(M08_CBC_EOS_PCT_LBORRES_", num, ")"))), na.rm = TRUE), #  & SITE != "Pakistan"
              " (",
            ...
            "Missing Platelet Distribution Width (PDW): n (%)*" = paste0(
              sum(eval(parse(text = paste0("is.na(M08_CBC_PDW_CT_LBORRES_", num, ")","&", "pdw_denom_lab_08_", num, " == 1"))) & !SITE %in% c("Pakistan", "India-SAS"), na.rm = TRUE),
              " (",
              format(round(sum(eval(parse(text = paste0("is.na(M08_CBC_PDW_CT_LBORRES_", num, ")","&", "pdw_denom_lab_08_", num, " == 1"))) & !SITE %in% c("Pakistan", "India-SAS") & denom_lab_08_1 ==1, na.rm = TRUE)/sum( eval(parse(text = paste0("pdw_denom_lab_08_", num, " == 1"))) & !SITE %in% c("Pakistan", "India-SAS") & denom_lab_08_1 ==1, na.rm = TRUE)*100, 2), nsmall = 0, digits = 2),
              ")"),
            "Missing Plateletcrit (PCT) (%): n (%)*" = paste0(
              sum(eval(parse(text = paste0("is.na(M08_CBC_PCT_PCT_LBORRES_", num, ")"))) & !SITE %in% c("Pakistan", "India-SAS"), na.rm = TRUE),
              " (",
              format(round(sum(eval(parse(text = paste0("is.na(M08_CBC_PCT_PCT_LBORRES_", num, ")"))) & !SITE %in% c("Pakistan", "India-SAS") & denom_lab_08_1 ==1, na.rm = TRUE)/sum(!SITE %in% c("Pakistan", "India-SAS") & denom_lab_08_1 ==1, na.rm = TRUE)*100, 2), nsmall = 0, digits = 2),
              ")")
          ) %>%
          t() %>% unlist()
      ) %>%
      ...
      add_column(
        ...
        "Total" = df_lab %>%
          ...
          plyr::summarise(
            ...
            #Hemoglobin A1c (P: En)
            "Missing HbA1c: n (%)*" = paste0(
              sum(eval(parse(text = paste0("is.na(M08_HBA1C_LBORRES_", num, ")"))) & SITE %in% c("Ghana", "Zambia") & denom_lab_08_1==1),
              " (",
              format(round(sum(eval(parse(text = paste0("is.na(M08_HBA1C_LBORRES_", num, ")"))) & SITE %in% c("Ghana", "Zambia") & denom_lab_08_1==1)/sum(SITE %in% c("Ghana", "Zambia") & denom_lab_08_1==1, na.rm = TRUE)*100, 2), nsmall = 0, digits = 2),
              ")"),
            #Hemoglobin A1c (P: En)
            "Missing HbA1c (%): n (%)*" = paste0(
...
matrix3_7 <- df_rbc %>%
    ...
    tb3_7 <- tb_theme2(matrix3_7) %>%
      ...
      tab_source_note(
        source_note = c("Note: Testing stopped: 2024-10-29 (Ghana); 2024-01-17 (Pakistan).")
      ) %>%
      tab_style(
        style = list(
          cell_text(color = "red") 
...
```{r}
    ...
    tb3_10 <- tb_theme2(matrix3_10) %>%
      ...
      tab_footnote(
        footnote = c("Note: CT/NG testing stopped Ghana: 2025-04-01;SAS: 2025-03-06;Kenya: 2025-02-27; Pakistan: 2025-04-24")
      ) %>%
      # tab_footnote(
      #   footnote = c("Note: We do not expect CT/NG test results at this time for most sites, as the testing plans are to batch test in 2025.")
      # ) %>%
...
matrix3_12 <- df_g6pd_77na %>%
    ...
    summarise(
      ...
      #              format(round(sum(if_all(var_columns, is.na))/n()*100, 2), nsmall = 0, digits = 2), ")"),
      # 
      "Missing Glucose-6-Phosphate Dehydrogenase (G6PD): n (%)*" = paste0(sum(g6pd_missing & denom_remapp == 1, na.rm=TRUE), " (",
                   format(round(sum(g6pd_missing & denom_remapp == 1, na.rm=TRUE)/sum(denom_remapp == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2), ")") 
    ) %>%
    t() %>% as.data.frame() %>%
    `colnames<-`(c(.[1,])) %>%
    slice(-1) %>%
    add_column(
      ...
      "Missing Glucose-6-Phosphate Dehydrogenase (G6PD): n (%)*2" = paste0(sum(g6pd_missing & denom_remapp == 1, na.rm=TRUE), " (",
                   format(round(sum(g6pd_missing & denom_remapp == 1, na.rm=TRUE)/sum(denom_remapp == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2), ")")         #   "Missing Glucose-6-Phosphate Dehydrogenase (G6PD): n (%)*" = paste0(sum(if_all(var_columns, is.na)), " (",
      ...
      add_column(
        ...
        plyr::summarise(
            ...
            "Missing Neutrophils (full cell count) : n (%)*" = paste0(
              sum(eval(parse(text = paste0("is.na(M08_CBC_NEU_FCC_LBORRES_", num, ")"))) & SITE != "Pakistan", na.rm = TRUE),
              " (",
              format(round(sum(eval(parse(text = paste0("is.na(M08_CBC_NEU_FCC_LBORRES_", num, ")"))) & SITE != "Pakistan", na.rm = TRUE)/sum(SITE != "Pakistan" & denom==1, na.rm = TRUE) *100, 2), nsmall = 0, digits = 2),
              ")"),
            "Missing Lymphocyte (%): n (%)*" = paste0(
              sum(eval(parse(text = paste0("is.na(M08_CBC_LYMPH_PCT_LBORRES_", num, ")")))),
              " (",
            ...
            "Missing Lymphocyte (full cell count): n (%)*" = paste0(
              sum(eval(parse(text = paste0("is.na(M08_CBC_LYMPH_FCC_LBORRES_", num, ")"))) & SITE != "Pakistan", na.rm = TRUE),
              " (",
              format(round(sum(eval(parse(text = paste0("is.na(M08_CBC_LYMPH_FCC_LBORRES_", num, ")"))) & SITE != "Pakistan", na.rm = TRUE)/sum(SITE != "Pakistan" & denom==1, na.rm = TRUE)*100, 2), nsmall = 0, digits = 2),
              ")"),
            "Missing Erythrocyte Count: n (%)*" = paste0(
              sum(eval(parse(text = paste0("is.na(M08_CBC_ERYTH_MM_LBORRES_", num, ")")))),
              " (",
