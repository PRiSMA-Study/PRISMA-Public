...
global dadate "2025-04-18" // this should be considered the date the data was most recently updated & will be used to calculate whether different gestational windows are completed
...
* Fix missing indicator for ANEMIA_ANC overall (denom = PREG_END): 
	...
	* Update for Xiaoyan -- add HB_LEVEL_ANC outcome: 
	...
	*1st merge in high HB dataset (highest HB in pregnancy):
	merge 1:1 MOMID PREGID using "$wrk/ANEMIA_ANC_HIGH-HB"
		...
		drop  _merge PREG_START_DATE ENTRY_TOTAL POC_COUNT REMAPP_*
	...
	**** end information:
	...
	sankey_plot ANEMIA_T1 ANEMIA_T2 ANEMIA_T3 ANEMIA_PNC6, wide width(newid) ///
		fillcolor(%50) ///
		xlabel("",nogrid) gap(0.1) tight ///
		title("Anemia Status by Trimestera through PNC6") ///
		subtitle ("Completed pregnancies recruited in Trimester 1")	
