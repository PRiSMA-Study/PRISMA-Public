...
//CREATE VARIABLES FOR MATERNAL MORTALITY //
	...
	**Look at cause of death:
	...
	assert COD_MISS == 1 if MAT_DEATH_CAUSE == 55 
...
//make short file for maternal outcomes
	...
	keep SITE MOMID PREGID PREG_END ENROLL MAT_DEATH MAT_DEATH_DATE MAT_DEATH_MISSCAUSE MAT_DEATH_MISSDATE  MAT_DEATH_42 MAT_MORTALITY MAT_MORTALITY_LATE 
