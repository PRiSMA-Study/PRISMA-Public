...
*Updated May 13 2026 by E Cook
	*Error in STFR code corrected
...
global datadate "2026-05-01"
	*data upload date
global latest_report_date "2026-05-01"
	*date of latest quarterly report (full datasets)
	*if running for quarterly report, put datadate
global runquery 0
...
global emma "Z:\Emma_working_files"

cap mkdir "$emma/nutrition"
cd "$emma/nutrition"
global wrk "$emma/nutrition/$datadate"
	cap mkdir "$wrk"
...
gl data "D:/Users/emmacook/Documents/data"
	
*******************************************************************
*Import & clean data

use "$data/$datadate/mnh07.dta", clear
...
use "$data/$datadate/mnh08.dta", clear 
...
**#Hemoglobin: 
	...
	**# Loop for different time points:
	...
	foreach var in 	VITB12_COB CRP AGP INFLAMMATION FERRITIN70 HIGH_TG STFR RBP4 MCV FOL_SERUM FOL_RBC FOL_ANY QUANSYS_TEST {
	...
	*PNC6
	...
	label val FOL_RBC FOL_RBC_ANC20 FOL_RBC_ANC32 FOL_RBC_PNC6 FOL_RBC_T*  FOL_RBC
...
merge 1:1 MOMID PREGID using "Z:\Emma_working_files\Expected-obs/Expected_obs-$datadate.dta" , gen(merge_exp)
...
keep SITE MOMID PREGID ENROLL REMAPP_ENROLL MCV_* VITB12_* FERRITIN* HIGH_TG* STFR* RBP4* CRP* AGP* INFLAMMATION* QUANSYS_T* FOL_ANY_* FOL_SERUM_* FOL_RBC_* *_EXP
drop FOL_RBC_CALC
