...
*/
	...
	**Update below based on date
	...
	global latest_out "Z:\Outcome Data\2026-05-01"
	
	**Set up directories and paths
	
	cap mkdir "Z:\Emma_working_files\Placenta-Previa/$datadate\"
	//auto-creates the folder if it does not already exist
	
	global wrk "Z:\Emma_working_files\Placenta-Previa/$datadate"
	cd "$wrk"		
