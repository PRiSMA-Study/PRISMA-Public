...
*Updated March 4, 2026 by E Cook
...
*******************************************************************
global da "D:/Users/emmacook/Documents/data/$datadate"
global outcomes "Z:\Outcome Data/$datadate"
gl stacked "Z:/Stacked Data/$datadate"

global wrk "Z:\Emma_working_files\depression/$datadate"
...
*Save queries:
global queries "Z:\Emma_working_files\depression/$datadate\queries"
...
clear
import delimited "$stacked/mnh25_merged.csv", bindquote(strict) case(upper) 
rename M25_* *
...
**************************************************
	...
	merge 1:1 MOMID PREGID using "Z:\Emma_working_files\Expected-obs\Expected_obs-$datadate.dta", nogen
