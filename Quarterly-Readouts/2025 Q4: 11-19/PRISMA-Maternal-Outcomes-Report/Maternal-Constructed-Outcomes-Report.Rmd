...
summary_tab1 <- infection1 %>%
  ...
  ## HIV
    "HIV prevalence at enrollment (positive RDT or diagnosed)" = paste0(
    ...
    ## Malaria
    "Malaria prevalence at enrollment (positive RDT or diagnosed)" = paste0(
    ...
    # Hepatitis B
    "Hep B RDT positive at enrollment" = paste0(
      ...
      "Hep C RDT positive at enrollment" = paste0(
