...
psbi_tab_output1 <- tb_theme1(psbi_tab1) %>% 
 ...
 tab_row_group(
  ...
  tab_footnote(
      footnote = html("<span style='font-size: 18px'><sup>a</sup> Missing confirmatory respiratory rate measurements among those with a RR>=60 breaths per minute. Denominator is n total psbi case at the specified visit.</span>")
   ) %>% 
  tab_footnote(
      footnote = html("<span style='font-size: 18px'><sup>b</sup> Missing confirmatory temperature among those with a temperature reading >=38C or <35.5C.Denominator is n total psbi case at the specified visit.</span>")
   ) 
...
<!-- ### Table 11 PSBI - WITH confirmatory measurements for temp/hypothermia -->
<!-- ```{r, psbi_2, message = FALSE, warning = FALSE} -->
<!-- # Has the baby had difficulty in feeding -->
<!-- # Has the baby had convulsions?  -->
<!-- # Has the baby had fast or difficult breathing? (60 breaths per minute or more) -->
<!-- # Does infant have severe chest in-drawing? -->
...
<!-- psbi_tab_confirm <- psbi_confirm %>% ## Denominator is all live births aged 0-59 days -->
<!--   rowwise() %>%  -->
<!--   group_by(SITE) %>%  -->
<!--   summarise( -->
...
<!--             "Fever (>=38C)      " = paste0( -->
<!--             format(sum(INF_PSBI_HOSPITAL == 1 & (M20_TEMP_VSORRES >= 38 & M20_TEMP_VSORRES >= 38), na.rm = TRUE), nsmall = 0, digits = 2)),  -->
...
<!-- psbi_tab_confirm <- psbi_tab_confirm %>%  -->
<!--   mutate_all(funs(str_replace(., "NaN", "0")))  -->

<!-- # replace NA with 0s (this likely means there is not yet data) -->
<!-- psbi_tab_confirm[is.na(psbi_tab_confirm)] <- paste0("0 (0)") -->


<!-- psbi_tab1 <- psbi_tab_confirm[1:22,] -->
<!-- psbi_tab2 <- psbi_tab_confirm[23:50,] -->
...
<!--   row_group_order(groups = c("<span style='font-size: 18px'>PSBI by visit<sup>a</sup></span>"))  -->
