...
-   Expected denominator: women who have passed 42 days postpartum
...
near_miss_taba <- near_miss %>% 
  ...
  summarise(
    ...
    "Near-miss denominator <sup>a</sup> , n" = paste0(
...
near_miss_tab_outputa <- tb_theme1(near_miss_taba) %>% 
 ...
 # bold denominator 1st and last row
  tab_style(
      style = list(
        cell_text(weight = "bold")
        ),
      locations = cells_body(rows = c(
                 ...
                 "Near-miss denominator <sup>a</sup> , n"))) %>% 
tab_style(
      style = list(
        cell_text(weight = "bold")
        ),
...
-   **preeclampsia** [to be constructed]

-   **severe hypertension** [to be constructed]

-   **pulmonary edema** [M09_PREECLAMPSIA_CEOCCUR_4]

-   **eclampsia** [to be constructed]
