...
knitr::include_graphics(paste0(path_to_data, "anemia_fig.jpg"))
...
tab_style(
  ...
  tab_style(
      ...
      locations = cells_body(rows = c(
                 "Expected denominator (PNC52 window completed, >64 weeks postpartum)",
                 "Expected denominator (PNC52 window completed, >64 weeks postpartum)"))) %>%
tab_style(
      style = list(
        cell_text(weight = "bold")
 ...
 row_group_order(groups = c("<span style='font-size: 18px'>Data completeness at PNC52<sup>a</sup></span>",
                            "<span style='font-size: 18px'>Anemia prevalence at PNC52 (lowest Hb measure)</span>",
                     "<span style='font-size: 18px'>Test type (for lowest Hb measure)</span>")) %>%
...
depression_complete_output <- tb_theme1(depression_complete_tab) %>%
 ...
 row_group_order(groups = c( "<span style='font-size: 18px'>Data Completeness, Trimester 1-2</span>",
                            "<span style='font-size: 18px'>Data Completeness, Trimester 3</span>",
                            "<span style='font-size: 18px'>Data Completeness, 6 weeks postpartum</span>")) %>%
...
depression_standard_output <- tb_theme1(depression_standard_tab) %>%
 ...
 row_group_order(groups = 
                   c( "<span style='font-size: 18px'>Depressive symptoms, ever</span>",
                      "<span style='font-size: 18px'>Depressive symptoms, ANC ever</span>",
                      "<span style='font-size: 18px'>Depressive symptoms, 1st & 2nd trimester</span>",
                      "<span style='font-size: 18px'>Depressive symptoms, 3rd trimester</span>",
                      "<span style='font-size: 18px'>Depressive symptoms, postpartum</span>"
                ) ) %>%
...
tab_style(
      ...
      locations = cells_stub(rows = c(
                 ...
                 "Expected denominator (total completed pregnancies)"))) %>%
 row_group_order(groups = c("<span style='font-size: 18px'>Data completeness <sup>a</sup></span>",
                           "<span style='font-size: 18px'>Obstructed labor prevalence</span>"))  %>%
...
thy_tab_hyper_output <- tb_theme1(thy_tab_hyper) %>%
 ...
 row_group_order(groups = c( "<span style='font-size: 18px'>Enrollment</span>",
                             NA,
                            "<span style='font-size: 18px'>Trimester 3</span>"))  %>%
...
placenta_tab_output <- tb_theme1(placenta_tab) %>%
 ...
 row_group_order(groups = c( "<span style='font-size: 18px'>Placenta previa</span>",
                            "<span style='font-size: 18px'>Placental abruption & accreta</span>"))  %>%
...
highhb_output <- tb_theme1(highhb_tab) %>%
 ...
 row_group_order(groups = c("<span style='font-size: 18px'>Data completeness <sup>a</sup></span>",
                   "<span style='font-size: 18px'>High hemoglobin prevalence (highest Hb measure)</span>",
                  "<span style='font-size: 18px'>Test type (for highest Hb measure)</span>"
                  )) %>%
