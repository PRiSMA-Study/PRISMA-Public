...
placenta_tab <- placenta %>% 
  ...
  summarise(
     ...
     "All livebirths and stillbirths" = paste0(
      format(sum(SB_LB == 1, na.rm = TRUE), nsmall = 0, digits = 2)),
     
      "Deliveries by Cesarean" = paste0(
     ...
     "Placenta accreta indicated as reason for C-section^a^" = paste0(
...
placenta_tab_output <- tb_theme1(placenta_tab) %>% 
 ...
 row_group_order(groups = c( "<span style='font-size: 18px'>Data completeness</span>",
  ...
  tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>a</sup>Denominator is deliveries by Cesarean</span>" ))
