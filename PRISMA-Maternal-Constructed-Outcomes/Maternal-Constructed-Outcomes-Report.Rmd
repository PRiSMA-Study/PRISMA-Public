...
# Erin's path: 
path_to_data <- "D:/Users/emoakley/Documents/Outcome Data/2024-06-17/" ##offline copy
...
preterm_indication <- read_dta(paste0(path_to_data, "PREGEND.dta"))  %>% rename_all(toupper) %>% filter(SITE != "")
...
-   No lab forms dated in pregnancy
...
anemia_tab <- anemia %>% 
  ...
  summarise(
    ...
    "Denominator (completed pregnancies)" = paste0(
    ...
    "Denominator (non-missing)" = paste0(
      ...
      " (",
      format(round(sum(ANEMIA_ANC_MISS ==0 & PREG_END==1, na.rm = TRUE)/sum(PREG_END==1 & ANEMIA_ANC_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
anemia_output <- tb_theme1(anemia_tab) %>% 
  ...
  tab_row_group(
    label = html("<span style='font-size: 18px'>Denominator for anemia prevalence</span>"),
    rows = 5:11
  ) %>%
  tab_row_group(
    label = html("<span style='font-size: 18px'>Anemia prevalence</span>"),
    rows = 6:11
  ) %>%
  tab_row_group(
 ...
 row_group_order(groups = c("<span style='font-size: 18px'>Denominator for data completeness</span>",
                  ...
                  "<span style='font-size: 18px'>Denominator for anemia prevalence</span>",
                   "<span style='font-size: 18px'>Anemia prevalence</span>",
...
-   No lab forms dated in the trimester of interest
...
anemia_tab_tri1 <- anemia %>% 
  ...
  ## trimester 1
    ...
    "Denominator (completed trimester 1 & recruited at <14 weeks GA)" = paste0(
      format(sum(ANEMIA_T1_DENOM==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_T1_DENOM==1, na.rm = TRUE)/sum(ANEMIA_T1_DENOM==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    "No lab forms in trimester 1" = paste0(
    ...
    "Denominator (non-missing)" = paste0(
      ...
      " (",
      format(round(sum(ANEMIA_T1_MISS ==0 & ANEMIA_T1_DENOM==1, na.rm = TRUE)/sum(ANEMIA_T1_DENOM==1 & ANEMIA_T1_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
#T2
    ...
    "Denominator (continued pregnancy & completed trimester 2)" = paste0(
      format(sum(ANEMIA_T2_DENOM==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_T2_DENOM==1, na.rm = TRUE)/sum(ANEMIA_T2_DENOM==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    "No lab forms in trimester 2" = paste0(
    ...
    "Denominator (non-missing)" = paste0(
      ...
      " (",
      format(round(sum(ANEMIA_T2_MISS ==0 & ANEMIA_T2_DENOM==1, na.rm = TRUE)/sum(ANEMIA_T2_DENOM==1 & ANEMIA_T2_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
anemia_tab_tri3 <- anemia %>% 
  ...
  summarise(
    ...
    "Denominator (continued pregnancy & completed trimester 3)" = paste0(
      format(sum(ANEMIA_T3_DENOM==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_T3_DENOM==1, na.rm = TRUE)/sum(ANEMIA_T3_DENOM==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    "No lab forms in trimester 3" = paste0(
    ...
    "Denominator (non-missing)" = paste0(
      ...
      " (",
      format(round(sum(ANEMIA_T3_MISS ==0 & ANEMIA_T3_DENOM==1, na.rm = TRUE)/sum(ANEMIA_T3_DENOM==1 & ANEMIA_T3_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
anemia_pph6_tab <- anemia %>% 
  ...
  ## pnc6
    ...
    "Denominator (PNC6 window completed)" = paste0(
      format(sum(ANEMIA_PNC6_DENOM==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_PNC6_DENOM==1, na.rm = TRUE)/sum(ANEMIA_PNC6_DENOM==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    "No lab forms in PNC6 window" = paste0(
    ...
    "Denominator (non-missing)" = paste0(
      ...
      " (",
      format(round(sum(ANEMIA_PNC6_MISS ==0 & ANEMIA_PNC6_DENOM==1, na.rm = TRUE)/sum(ANEMIA_PNC6_DENOM==1 & ANEMIA_PNC6_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
anemia_pph26_tab <- anemia %>% 
  ...
  summarise(
    ...
    "Denominator (PNC26 window completed)" = paste0(
      format(sum(ANEMIA_PNC26_DENOM==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_PNC26_DENOM==1, na.rm = TRUE)/sum(ANEMIA_PNC26_DENOM==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    "No lab forms in PNC26 window" = paste0(
...
anemia_pph6_output <- tb_theme1(anemia_pph6_tab) %>% 
  tab_header(
    title = md("**Table 2c**")) %>% 
  tab_row_group(
    label = html("<span style='font-size: 18px'>Denominator for PNC6<sup>a</sup></span>"),
        rows = 1:10
    ) %>%
  tab_row_group(
    label = html("<span style='font-size: 18px'>Data completeness at PNC6</span>"),
        rows = 2:10
    ) %>%
  tab_row_group(
    label = html("<span style='font-size: 18px'>Denominator for anemia prevalence</span>"),
  ...
  tab_row_group(
    label = html("<span style='font-size: 18px'>Anemia prevalence at PNC6</span>"),
    rows = 5:10
  ) %>%
  tab_row_group(
    label = html("<span style='font-size: 18px'>Test type (for lowest Hb measure)</span>"),
 ...
 row_group_order(groups = c( "<span style='font-size: 18px'>Denominator for PNC6<sup>a</sup></span>",
                            "<span style='font-size: 18px'>Data completeness at PNC6</span>",
                            "<span style='font-size: 18px'>Denominator for anemia prevalence</span>",
                            "<span style='font-size: 18px'>Anemia prevalence at PNC6</span>",
                     "<span style='font-size: 18px'>Test type (for lowest Hb measure)</span>")) %>% 
  
  tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>a</sup> This outcome is based on tests collected during the PNC-6 late visit window (6-12 weeks postpartum); the data completeness denominator includes any participant with a valid lab test during this window, as well as participants without lab data who have progressed in the study through the PNC-6 window.</span>")) %>%   
...
anemia_pph26_output <- tb_theme1(anemia_pph26_tab) %>% 
  ...
  tab_row_group(
    label = html("<span style='font-size: 18px'>Denominator for PNC26<sup>a</sup></span>"),
        rows = 1:10
    ) %>%
  tab_row_group(
    label = html("<span style='font-size: 18px'>Data completeness at PNC26</span>"),
        rows = 2:10
    ) %>%
  tab_row_group(
    label = html("<span style='font-size: 18px'>Denominator for anemia prevalence</span>"),
  ...
  tab_row_group(
    label = html("<span style='font-size: 18px'>Anemia prevalence at PNC26</span>"),
    rows = 5:10
  ) %>%
  tab_row_group(
    label = html("<span style='font-size: 18px'>Test type (for lowest Hb measure)</span>"),
 ...
 row_group_order(groups = c( "<span style='font-size: 18px'>Denominator for PNC26<sup>a</sup></span>",
                            "<span style='font-size: 18px'>Data completeness at PNC26</span>",
                            "<span style='font-size: 18px'>Denominator for anemia prevalence</span>",
                            "<span style='font-size: 18px'>Anemia prevalence at PNC26</span>",
                            "<span style='font-size: 18px'>Test type (for lowest Hb measure)</span>")) %>% 
  
  tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>a</sup> This outcome is based on tests collected during the PNC-26 late visit window (26-39 weeks postpartum); the data completeness denominator includes any participant with a valid lab test during this window, as well as participants without lab data who have progressed in the study through the PNC-26 window. Note that participants who had an early pregnancy loss (<20 weeks GA) are excluded from this PNC-26 measure per study follow-up protocol. </span>")) %>%   
...
preterm_tab <- preterm_indication %>% 
  ...
  summarise(
    ...
    "Denominator (non-missing)" = paste0(
      ...
      " (",
      format(round(sum(PREG_END_DELIV==1 & PRETERM_PROV_MISS==0, na.rm = TRUE)/sum(PREG_END_DELIV==1 & PRETERM_PROV_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
preterm_tab_output <- tb_theme1(preterm_tab) %>% 
  ...
  tab_row_group(
    label = html("<span style='font-size: 18px'>Denominator for preterm delivery/classification</span>"),
    rows = 7:11
  ) %>%
  tab_row_group(
 ...
 row_group_order(groups = c( "<span style='font-size: 18px'>Denominator for data completeness</span>",
                            "<span style='font-size: 18px'>Data completeness</span>",
                            "<span style='font-size: 18px'>Denominator for preterm delivery/classification</span>",
...
uter_rup_tab <- preterm_indication %>% 
  rowwise() %>% 
  group_by(SITE) %>% 
  summarise(
...
prolong_tab <- preterm_indication %>% 
  rowwise() %>% 
  group_by(SITE) %>% 
  summarise(
