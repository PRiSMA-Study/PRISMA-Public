...
# maternal infection 
# Table 1 Data: 
# remove these datasets per Stacie's feedback: 
...
Hemorrhage_tab <- hemorrhage %>% 
  ...
  ## hemorrhage outcome 
    ...
    "Any hemorrhage at any time point^c^" = paste0(
...
hemorrhage_output1 <- tb_theme1(Hemorrhage_tab1) %>% 
  ...
  tab_row_group(
    label = html("<span style='font-size: 18px'>Procedures for postpartum hemorrhage <sup>d</sup></span>"),
    rows = 6:12
  ) %>%
  row_group_order(groups = c("<span style='font-size: 18px'>Hemorrhage</span>",
                           "<span style='font-size: 18px'>Procedures for postpartum hemorrhage <sup>d</sup></span>")) %>% 
  tab_style(
      style = list(
  ...
  tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>c</sup> Denominator is all participants with an ANC or IPC visit (MNH09 filled).</span>")
 ) %>% 
  tab_footnote(
...
hemorrhage_output2 <- tb_theme1(Hemorrhage_tab2) %>% 
      ...
      tab_row_group(
        label = html("<span style='font-size: 18px'>Methods of blood loss measurements<sup>e</sup></span>"),
        rows = 9:13
      ) %>%
      row_group_order(groups = c("<span style='font-size: 18px'>Medications given to prevent/treat postpartum hemorrhage<sup>b</sup></span>",
                                 "<span style='font-size: 18px'>Methods of blood loss measurements<sup>e</sup></span>")) %>% 
      tab_footnote(
        footnote = html("<span style='font-size: 18px'><sup>b</sup> Denominator is all participants with an IPC visit (MNH09 filled).</span>")
     ) %>% 
      tab_footnote(
        footnote = html("<span style='font-size: 18px'><sup>e</sup> Denominator is all participants with a valid blood loss at IPC measurement (varname [form]: `PPH_ESTIMATE_FAORRES` [MNH09]). </span>")
     )
```
