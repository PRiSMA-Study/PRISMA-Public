...
summary_tab_output <- tb_theme1(summary_tab) %>%
 ...
 row_group_order(groups = c( "<span style='font-size: 18px'>Enrollment outcomes</span>",
  ...
  tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>a</sup> Denominator is total participants with an enrollment visit. For malaria, Hep B and Hep C, denominator only includes particpants who have had a RDT performed at enrollment.</span>")
 ) %>%
