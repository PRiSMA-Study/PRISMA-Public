...
anemia_output <- tb_theme1(anemia_tab) %>% 
  tab_header(
    title = md("**Table 2a**")) %>% 
  tab_row_group(
    label = html("<span style='font-size: 18px'>Denominator: Completed pregnancies</span>"),
    rows = 1:11
  ) %>%
  tab_row_group(
    label = html("<span style='font-size: 18px'>Data Completeness</span>"),
  ...
  tab_row_group(
    label = html("<span style='font-size: 18px'>Denominator: Completed pregnancies with outcome data</span>"),
    rows = 5:11
  ) %>%
  tab_row_group(
 ...
 row_group_order(groups = c("<span style='font-size: 18px'>Denominator: Completed pregnancies</span>",
                  "<span style='font-size: 18px'>Data Completeness</span>",
                  "<span style='font-size: 18px'>Denominator: Completed pregnancies with outcome data</span>",
...
-   The participant has completed the trimester of interest based on the Best Obstetric Estimate of the participant’s due date collected at enrollment and the date of the most recent data upload to Synapse.
...
anemia_tab_tri1 <- anemia %>% 
  ...
  ## trimester 1
    ...
    "Missing both US and LMP GA or ultrasound date [MNH01]" = paste0(
      format(sum(ANEMIA_ANC_T1_MISS== 1 & ENROLL_T1==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T1_MISS == 1 & ENROLL_T1==1, na.rm = TRUE)/sum(ENROLL_T1==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Missing BOTH CBC result and POC result with a sample date in Trimester 1" = paste0(
      format(sum(ANEMIA_ANC_T1_MISS  ==2, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T1_MISS ==2 & ENROLL_T1==1 & COMPLETE_T1==1, na.rm = TRUE)/sum(ENROLL_T1==1 & COMPLETE_T1==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

    "No anemia (>=11 g/dL)" = paste0(
      format(sum(ANEMIA_ANC_T1 == 0 & ENROLL_T1==1 & COMPLETE_T1==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T1 == 0 & ENROLL_T1==1 & COMPLETE_T1==1, na.rm = TRUE)/sum(ENROLL_T1==1 & COMPLETE_T1==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Mild anemia (>=10 & <11 g/dL)" = paste0(
      format(sum(ANEMIA_ANC_T1 == 1 & ENROLL_T1==1 & COMPLETE_T1==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T1 == 1 & ENROLL_T1==1 & COMPLETE_T1==1, na.rm = TRUE)/sum(ENROLL_T1==1 & COMPLETE_T1==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
     "Moderate anemia (>=7 & <10 g/dL)" = paste0(
      format(sum(ANEMIA_ANC_T1 == 2 & ENROLL_T1==1 & COMPLETE_T1==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T1 == 2 & ENROLL_T1==1 & COMPLETE_T1==1, na.rm = TRUE)/sum(ENROLL_T1==1 & COMPLETE_T1==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Severe anemia (< 7 g/dL)" = paste0(
      format(sum(ANEMIA_ANC_T1 == 3 & ENROLL_T1==1 & COMPLETE_T1==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T1 == 3 & ENROLL_T1==1 & COMPLETE_T1==1, na.rm = TRUE)/sum(ENROLL_T1==1 & COMPLETE_T1==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Missing (no hemoglobin data with test date in Trimester 1)" = paste0(
      format(sum(ANEMIA_ANC_T1 == 55 & ENROLL_T1==1 & COMPLETE_T1==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T1 == 55 & ENROLL_T1==1 & COMPLETE_T1==1, na.rm = TRUE)/sum(ENROLL_T1==1 & COMPLETE_T1==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")")
...
anemia_tab_tri2 <- anemia %>% 
  ...
  ## trimester 2
    ...
    "Missing both US and LMP GA or ultrasound date [MNH01] " = paste0(
      format(sum(ANEMIA_ANC_T2_MISS== 1 & COMPLETE_T2==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T2_MISS== 1 & COMPLETE_T2==1, na.rm = TRUE)/sum(COMPLETE_T2==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Missing BOTH CBC result and POC result with a sample date in Trimester 2" = paste0(
      format(sum(ANEMIA_ANC_T2_MISS==2 & COMPLETE_T2==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T2_MISS==2 & COMPLETE_T2==1, na.rm = TRUE)/sum(COMPLETE_T2==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

    "No anemia (>=11 g/dL) " = paste0(
      format(sum(ANEMIA_ANC_T2 == 0 & COMPLETE_T2==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T2 == 0 & COMPLETE_T2==1, na.rm = TRUE)/sum(COMPLETE_T2==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Mild anemia (>=10 & <11 g/dL) " = paste0(
      format(sum(ANEMIA_ANC_T2 == 1 & COMPLETE_T2==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T2 == 1 & COMPLETE_T2==1, na.rm = TRUE)/sum(COMPLETE_T2==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
     "Moderate anemia (>=7 & <10 g/dL) " = paste0(
      format(sum(ANEMIA_ANC_T2 == 2 & COMPLETE_T2==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T2 == 2 & COMPLETE_T2==1, na.rm = TRUE)/sum(COMPLETE_T2==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Severe anemia (< 7 g/dL) " = paste0(
      format(sum(ANEMIA_ANC_T2 == 3 & COMPLETE_T2==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T2 == 3 & COMPLETE_T2==1, na.rm = TRUE)/sum(COMPLETE_T2==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Missing (no hemoglobin data with test date in Trimester 2) " = paste0(
      format(sum(ANEMIA_ANC_T2 == 55 & COMPLETE_T2==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T2 == 55 & COMPLETE_T2==1, na.rm = TRUE)/sum(COMPLETE_T2==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")")
  ) %>% 
  t() %>% as.data.frame() %>% 
  `colnames<-`(c(.[1,])) %>% 
...
anemia_tab_tri3 <- anemia %>% 
  ...
  summarise(
    ...
    ## trimester 3
    "Missing both US and LMP GA or ultrasound date [MNH01]  " = paste0(
      format(sum(ANEMIA_ANC_T3_MISS == 1 & COMPLETE_T3==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T3_MISS == 1 & COMPLETE_T3==1, na.rm = TRUE)/sum(COMPLETE_T3==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Missing BOTH CBC result and POC result with a sample date in Trimester 3" = paste0(
      format(sum(ANEMIA_ANC_T3_MISS ==2 & COMPLETE_T3==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T3_MISS ==2 & COMPLETE_T3==1, na.rm = TRUE)/sum(COMPLETE_T3==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

    "No anemia (>=11 g/dL)  " = paste0(
      format(sum(ANEMIA_ANC_T3 == 0 & COMPLETE_T3==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T3 == 0 & COMPLETE_T3==1, na.rm = TRUE)/sum(COMPLETE_T3==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Mild anemia (>=10 & <11 g/dL)  " = paste0(
      format(sum(ANEMIA_ANC_T3 == 1 & COMPLETE_T3==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T3 == 1 & COMPLETE_T3==1, na.rm = TRUE)/sum(COMPLETE_T3==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
     "Moderate anemia (>=7 & <10 g/dL)  " = paste0(
      format(sum(ANEMIA_ANC_T3 == 2 & COMPLETE_T3==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T3 == 2 & COMPLETE_T3==1, na.rm = TRUE)/sum(COMPLETE_T3==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Severe anemia (< 7 g/dL)  " = paste0(
      format(sum(ANEMIA_ANC_T3 == 3 & COMPLETE_T3==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T3 == 3 & COMPLETE_T3==1, na.rm = TRUE)/sum(COMPLETE_T3==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Missing (no hemoglobin data with test date in Trimester 3)  " = paste0(
      format(sum(ANEMIA_ANC_T3 == 55 & COMPLETE_T3==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ANEMIA_ANC_T3 == 55 & COMPLETE_T3==1, na.rm = TRUE)/sum(COMPLETE_T3==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")")
