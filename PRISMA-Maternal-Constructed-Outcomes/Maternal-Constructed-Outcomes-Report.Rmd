...
Hemorrhage_tab <- hemorrhage %>%
  ...
  summarise(
    ...
    "Procedure/blood transfusion ^b^" = paste0(
    ...
    "Est blood loss >= 1000mL ^b^" = paste0(
...
hemorrhage_output1 <- tb_theme1(Hemorrhage_tab1) %>%
  ...
  tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>b</sup> Denominator is participants with reported postpartum hemorrhage.</span>")
  ) 
