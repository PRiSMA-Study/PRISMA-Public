...
thy_tab <- thy %>%
  ...
  summarise(
     ...
     "Expected number at Enrollment, T1^a^" = paste0(
    ...
    "Denominator for T1 (non-missing)" = paste0(
     ...
     "Expected number at Enrollment, T2^a^" = paste0(
    ...
    "Denominator for T2 (non-missing)" = paste0(
...
thy_tab_output <- tb_theme1(thy_tab) %>%
 ...
 row_group_order(groups = c( "<span style='font-size: 18px'>Enrollment: Trimester 1</span>",
  ...
  tab_style(
      ...
      locations = cells_body(rows = c(
                 "Denominator for T1 (non-missing)",
                 "Denominator for T2 (non-missing)"))) %>%
tab_style(
      style = list(
        cell_text(weight = "bold")
        ),
  ...
  tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>a</sup> Expected denominator are those who were enrolled before enrollment thyroid testing was stopped (Ghana: 2024-09-01; India-CMC: 2024-10-17; India-SAS: n/a; Kenya: 2025-01-14; Pakistan: 2024-10-03; Zambia: 2024-10-11)</span>" ))
