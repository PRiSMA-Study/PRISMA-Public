...
tab_style(
 ...
 tab_footnote(
  ...
  tab_footnote(
     footnote = html("<span style='font-size: 18px'><sup>g</sup>Late pregnancy-related deaths are those occuring 43-365 days postpartum, for any reason.</span>")
  )  %>%
...
ggsave(paste0("hem_fig", ".pdf"), path = path_to_data,
       width = 8, height = 8)

knitr::include_graphics(paste0(path_to_data, "hem_fig.pdf"))
