...
sti_enroll_tab <- mat_infections_combined %>% 
  ...
  ## HIV
    ...
    "HIV diagnosis and RDT missing ^b^" = paste0(
  ...
  # Syphilis
    ...
    "Syphilis diagnosis and RDT missing, enrollment ^b^" = paste0(
...
malaria_tab <- mat_infections_combined %>% 
  ...
  ## Malaria
    ...
    "Malaria diagnosis and RDT missing ^b^" = paste0(
...
row_group_order(groups = c(NA,
  ...
  tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>b</sup> Denominator is total participants with an enrollment visit excluding missing (missing defined as default values reported for test results).</span>")
 ) %>% 
    tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>c</sup> Denominator is total participants who reported having at least one TB symptom in MNH04.</span>")
 ) 
