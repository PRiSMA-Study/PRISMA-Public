---
title: "<span style='font-size: 18px'> <span style='text-align: center'> PRISMA-Maternal-Outcomes (Issued: 2025 May 01)"
output:
  pdf_document:
    toc: no
    toc_depth: 6
...
#Savannah's paths
path_to_data <- "Z:/Outcome Data/2025-04-18/" 
path_to_save <- "D:/Users/savannah.omalley/Documents/Maternal Outcomes/Maternal Outcomes Report/Output/2025-04-18/"
...
#MAT_INFECTION <- read.csv(paste0(path_to_data, "MAT_INFECTION-CTNG-EXPANSION", ".csv"))
...
**Includes data from synapse last updated:** 2025 April 18
...
sti_enroll_tab <- MAT_INFECTION %>%
  ...
  ## HIV
    ...
    "HIV incidence following enrollment (positive RDT or diagnosed) ^b^" = paste0(
      format(sum(HIV_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(HIV_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
  ...
  # Syphilis
    ...
    "Syphilis incidence following enrollment (positive RDT or diagnosed) ^b^" = paste0(
      format(sum(SYPH_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(SYPH_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

    "Syphilis incidence following pregnancy (positive RDT or diagnosed) ^b^" = paste0(
      format(sum(SYPH_POSITIVE_ANY_PNC == 1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(SYPH_POSITIVE_ANY_PNC == 1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

    "Syphilis diagnosis and RDT missing at enrollment ^c^" = paste0(
      format(sum(SYPH_MISSING_ENROLL ==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(SYPH_MISSING_ENROLL ==1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
  ...
  ## VAGINAL SWAB TESTING
      ...
      "Chlamydia prevalence at enrollment^d^" = paste0(
      ...
      "Gonorrhea prevalence at enrollment^d^" = paste0(
      ...
      ## Chlamydia prevalence at enrollment
      "Chlamydia incidence following enrollment^d^" = paste0(
      ...
      ## Gonorrhea prevalence at enrollment
      "Gonorrhea incidence following enrollment^d^" = paste0(
  ...
  # Gonorrhea
    ...
    "Gonorrhea incidence following enrollment (diagnosed) ^b^" = paste0(
      format(sum(GON_POSITIVE_ANY_ANC == 1 & PREG_END == 1 , na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(GON_POSITIVE_ANY_ANC == 1 & PREG_END == 1 , na.rm = TRUE)/sum(PREG_END == 1 , na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
  ...
  # Chlamydia
    ...
    "Chlamydia incidence following enrollment (diagnosed) ^b^" = paste0(
      format(sum(CHL_POSITIVE_ANY_ANC == 1 & PREG_END == 1 , na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(CHL_POSITIVE_ANY_ANC == 1 & PREG_END == 1 , na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    # Genital ulcers
      ...
      format(sum(GENU_POSITIVE_ANY_ANC == 1 & PREG_END == 1 , na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(GENU_POSITIVE_ANY_ANC == 1 & PREG_END == 1 , na.rm = TRUE)/sum(PREG_END == 1 , na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
  ...
  # Other STIs
    ...
    "Other STIs incidence following enrollment (diagnosed) ^b^" = paste0(
      format(sum(OTHR_POSITIVE_ANY_ANC == 1 & PREG_END == 1 , na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(OTHR_POSITIVE_ANY_ANC == 1 & PREG_END == 1 , na.rm = TRUE)/sum(PREG_END == 1 , na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
tab_style(
  ...
  tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>b</sup> Denominator is total participants with a pregnancy outcome. Excludes cases reported at enrollment.</span>")
 ) %>%
  tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>c</sup> Denominator is total participants with an enrollment visit.</span>")
 )  %>%
  tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>d</sup> Denominator is total participants with a CT/NG swab and test performed.</span>")
 )
...
malaria_tab <- MAT_INFECTION %>%
  ...
  ## Malaria
    ...
    "Malaria incidence following enrollment (positive RDT or diagnosed) ^b^" = paste0(
      format(sum(MAL_POSITIVE_ANY_ANC == 1 & PREG_END ==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(MAL_POSITIVE_ANY_ANC == 1 & PREG_END ==1, na.rm = TRUE)/sum(PREG_END ==1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
hepatitis_tab <- MAT_INFECTION %>%
  ...
  # Hepatitis B
    ...
    "Hep B incidence following enrollment (positive RDT) ^b^" = paste0(
      format(sum(HBV_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(HBV_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
  ...
  # Hepatitis C
    ...
    "Hep C incidence following enrollment (positive RDT) ^b^" = paste0(
      format(sum(HCV_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(HCV_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
  ...
  "N with at least one expansion test performed" = paste0(
    ...
    "Hep E IgM incidence following enrollment ^e^" = paste0(
      format(sum(HEV_IGM_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(HEV_IGM_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

      "Hep E IgG incidence following enrollment ^e^" = paste0(
      format(sum(HEV_IGG_POSITIVE_ANY_ANC==1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(HEV_IGG_POSITIVE_ANY_ANC==1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

    "Hep E missing at enrollment (IgG or IgM) ^f^" = paste0(
...
hepatitis_tab_output <- tb_theme1(hepatitis_tab) %>%
 ...
 tab_row_group(
  ...
  tab_footnote(
    ...
    tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>e</sup> Denominator is total participants with a pregnancy outcome. Excludes cases reported at enrollment.</span>")
 ) %>% 
    tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>f</sup> Denominator is total participants with an enrollment visit and at least one HEV/ZCD/Lepto expansion test performed.</span>")
 )
...
tb_tab <- MAT_INFECTION %>%
  ...
  summarise(
    ...
    "TB symptoms incidence following enrollment ^b^" = paste0(
      format(sum(TB_SYMP_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(TB_SYMP_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    "TB sputum incidence following enrollment ^b^" = paste0(
      format(sum(TB_SPUTUM_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(TB_SPUTUM_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
zcd_tab <- MAT_INFECTION %>%
  ...
  # Zika
    ...
    "Zika IgM incidence following enrollment ^b^" = paste0(
      format(sum(ZIK_IGM_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ZIK_IGM_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

      "Zika IgG incidence following enrollment ^b^" = paste0(
      format(sum(ZIK_IGG_POSITIVE_ANY_ANC==1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ZIK_IGG_POSITIVE_ANY_ANC==1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    "Dengue IgM incidence following enrollment ^b^" = paste0(
      format(sum(DEN_IGM_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DEN_IGM_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

    "Dengue IgG incidence following enrollment ^b^" = paste0(
      format(sum(DEN_IGG_POSITIVE_ANY_ANC==1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DEN_IGG_POSITIVE_ANY_ANC==1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    "Chikungunya IgM incidence following enrollment ^b^" = paste0(
      format(sum(CHK_IGM_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(CHK_IGM_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

    "Chikungunya IgG incidence following enrollment ^b^" = paste0(
      format(sum(CHK_IGG_POSITIVE_ANY_ANC==1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(CHK_IGG_POSITIVE_ANY_ANC==1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
  ...
  # Leptospirosis
    ...
    "Leptospirosis IgM incidence following enrollment ^d^" = paste0(
      format(sum(LEP_IGM_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(LEP_IGM_POSITIVE_ANY_ANC == 1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

      "Leptospirosis IgG incidence following enrollment ^d^" = paste0(
      format(sum(LEP_IGG_POSITIVE_ANY_ANC==1 & PREG_END == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(LEP_IGG_POSITIVE_ANY_ANC==1 & PREG_END == 1, na.rm = TRUE)/sum(PREG_END == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
tab_style(
  ...
  tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>a</sup> Expected denominator are those who were enrolled during that trimester, before enrollment thyroid testing was stopped (Ghana: 2024-09-01; India-CMC: 2024-10-17; India-SAS: n/a; Kenya: 2025-01-14; Pakistan: 2024-10-03; Zambia: 2024-10-11)</span>" )) %>%
    tab_footnote(
