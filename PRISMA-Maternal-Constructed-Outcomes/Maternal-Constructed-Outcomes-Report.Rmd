...
# Erin's path: 
path_to_data <- "Z:/Outcome Data/2024-05-31/"
...
near_miss <- read_dta(paste0(path_to_data, "Depression.dta")) %>% rename_all(toupper)%>% filter(SITE != "")
...
preterm_tab <- preterm_indication %>% 
  ...
  summarise(
     ...
     "Excluded: maternal deaths prior to delivery" = paste0(
      format(sum(PREG_END== 1 & MAT_DEATH==1 & PREG_END_DELIV==0 & MAT_UTER_RUP_MISS==4, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(PREG_END== 1 & MAT_DEATH==1 & PREG_END_DELIV==0 & MAT_UTER_RUP_MISS==4, na.rm = TRUE)/sum(PREG_END== 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),  
...
**Denominator:** Passed the PNC6 window AND did not closeout during the window AND we have an MNH09/MNH12/MNH19 for that participant AND (we have seen them after the PNC6 window OR they have experienced severe complication, underwent a critical intervention, or organ failure).
...
near_miss_tab <- near_miss %>% 
  ...
  summarise(
    ...
    "Women who have passed 42 days after pregnancy end without closing out AND visit after six weeks OR have the event" = paste0(
    ...
    "Experienced organ dysfunction, n" = paste0(
    ...
    "Heart" = paste0(
      format(sum(ORG_FAIL_HRT ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ORG_FAIL_HRT ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE)/sum(NEAR_MISS_DENOM == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Respiratory" = paste0(
      format(sum(ORG_FAIL_RESP ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ORG_FAIL_RESP ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE)/sum(NEAR_MISS_DENOM == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

    "Renal/kidney" = paste0(
      format(sum(ORG_FAIL_RENAL ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ORG_FAIL_RENAL ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE)/sum(NEAR_MISS_DENOM == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Liver" = paste0(
      format(sum(ORG_FAIL_LIVER ==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ORG_FAIL_LIVER ==1, na.rm = TRUE)/sum(NEAR_MISS_DENOM == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Neurological" = paste0(
      format(sum(ORG_FAIL_NEUR ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ORG_FAIL_NEUR ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE)/sum(NEAR_MISS_DENOM == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
        
    "Uterine" = paste0(
      format(sum(ORG_FAIL_UTER ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ORG_FAIL_UTER ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE)/sum(NEAR_MISS_DENOM == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
            
    "Coagulation/hematological" = paste0(
      format(sum(ORG_FAIL_HEM ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ORG_FAIL_HEM ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE)/sum(NEAR_MISS_DENOM == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
                
    "Other" = paste0(
      format(sum(ORG_FAIL_OTHR ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ORG_FAIL_OTHR ==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE)/sum(NEAR_MISS_DENOM == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
                    
    "Maternal near miss (severe complication & organ failure)" = paste0(
...
```{r}
# replace NA with 0s (this likely means there is not yet data)
near_miss_tab[is.na(near_miss_tab)] <- paste0("0 (0)")

## the table is too long -- split into 2 
near_miss_tab1 <- near_miss_tab[1:9,]
near_miss_tab2 <- near_miss_tab[10:18,]
...
near_miss_tab_output1 <- tb_theme1(near_miss_tab1) %>% 
  ...
  tab_row_group(
    label = html("<span style='font-size: 18px'>Indicators of near-miss <sup>a</sup></span>"),
    rows = 4:9
  ) %>%
  row_group_order(groups = c("<span style='font-size: 18px'>Data completeness</span>",
                             "<span style='font-size: 18px'>Indicators of near-miss <sup>a</sup></span>"
                             ))  %>% 
  tab_footnote(
...
near_miss_tab_output2 <- tb_theme1(near_miss_tab2) %>% 
  ...
  tab_row_group(
    label = html("<span style='font-size: 18px'>Near-miss <sup>a</sup></span>"),
    rows = 9:9
  ) %>%
  row_group_order(groups = c("<span style='font-size: 18px'>Indicators of near-miss <sup>a</sup></span>",
                             "<span style='font-size: 18px'>Near-miss <sup>a</sup></span>"
                             ))  %>% 
  tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>a</sup> Passed the PNC6 window AND did not closeout during the window AND we have an MNH09/MNH12/MNH19 for that participant AND (we have seen them after the PNC6 window OR they have experienced severe complication, underwent a critical intervention, or organ failure).</span>")
 )
...
gtsave(near_miss_tab1, file = "near_miss_tab1.png", path = path_to_save, expand = 10)
...
gtsave(near_miss_tab2, file = "near_miss_tab2.png", path = path_to_save, expand = 10)
