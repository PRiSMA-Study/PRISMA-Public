---
title: "<span style='font-size: 18px'> <span style='text-align: center'> PRISMA-Maternal-Outcomes (Issued: 2025 January 29)"
output:
  pdf_document:
    toc: no
    toc_depth: 6
...
#Savannah's paths
path_to_data <- "Z:/Outcome Data/2025-01-10/" 
path_to_save <- "D:/Users/savannah.omalley/Documents/Maternal Outcomes/Maternal Outcomes Report/Output/2025-01-10/"
...
MAT_INFECTION <- read.csv(paste0(path_to_data, "MAT_INFECTION-CTNG", ".csv"))
...
**Includes data from synapse last updated:** 2025 January 10
...
# ## without percents
 mortality_tab <- mortality %>%
   ...
   summarise(
    ...
    "All pregnancy-related deaths^c^, n" = paste0(
    ...
    "All late pregnancy-related deaths^g^, n" = paste0(
 ...
 row_group_order(groups = c("<span style='font-size: 18px'>Deaths occurring at any point during pregnancy</span>",
  ...
  tab_style(
      ...
      locations = cells_body(rows = c(
                ...
                "All pregnancy-related deaths^c^, n",
                "All late pregnancy-related deaths^g^, n"))) %>% 
tab_style(
      style = list(
        cell_text(weight = "bold")
        ),
...
hepatitis_tab <- MAT_INFECTION %>% 
  ...
  "N with at least one expansion test performed" = paste0(
    ...
    "Hep E IgM incidence following enrollment ^d^" = paste0(
      format(sum(HEV_IGM_POSITIVE_ANY_ANC == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(HEV_IGM_POSITIVE_ANY_ANC == 1, na.rm = TRUE)/sum(EXPANSION_ENROLL == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
  
      "Hep E IgG incidence following enrollment ^d^" = paste0(
      format(sum(HEV_IGG_POSITIVE_ANY_ANC==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(HEV_IGG_POSITIVE_ANY_ANC==1, na.rm = TRUE)/sum(EXPANSION_ENROLL == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
zcd_tab <- MAT_INFECTION %>% 
  ...
  # Zika
    ...
    "Zika IgM incidence following enrollment ^b^" = paste0(
      format(sum(ZIK_IGM_POSITIVE_ANY_ANC == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ZIK_IGM_POSITIVE_ANY_ANC == 1, na.rm = TRUE)/sum(EXPANSION_ENROLL == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
  
      "Zika IgG incidence following enrollment ^b^" = paste0(
      format(sum(ZIK_IGG_POSITIVE_ANY_ANC==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(ZIK_IGG_POSITIVE_ANY_ANC==1, na.rm = TRUE)/sum(EXPANSION_ENROLL == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    "Dengue IgM incidence following enrollment ^b^" = paste0(
      format(sum(DEN_IGM_POSITIVE_ANY_ANC == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DEN_IGM_POSITIVE_ANY_ANC == 1, na.rm = TRUE)/sum(EXPANSION_ENROLL == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
  
    "Dengue IgG incidence following enrollment ^b^" = paste0(
      format(sum(DEN_IGG_POSITIVE_ANY_ANC==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DEN_IGG_POSITIVE_ANY_ANC==1, na.rm = TRUE)/sum(EXPANSION_ENROLL == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    "Chikungunya IgM incidence following enrollment ^b^" = paste0(
      format(sum(CHK_IGM_POSITIVE_ANY_ANC == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(CHK_IGM_POSITIVE_ANY_ANC == 1, na.rm = TRUE)/sum(EXPANSION_ENROLL == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
  
    "Chikungunya IgG incidence following enrollment ^b^" = paste0(
      format(sum(CHK_IGG_POSITIVE_ANY_ANC==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(CHK_IGG_POSITIVE_ANY_ANC==1, na.rm = TRUE)/sum(EXPANSION_ENROLL == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
  ...
  # Leptospirosis 
    ...
    "Leptospirosis IgM incidence following enrollment ^d^" = paste0(
      format(sum(LEP_IGM_POSITIVE_ANY_ANC == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(LEP_IGM_POSITIVE_ANY_ANC == 1, na.rm = TRUE)/sum(EXPANSION_ENROLL == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
  
      "Leptospirosis IgG incidence following enrollment ^d^" = paste0(
      format(sum(LEP_IGG_POSITIVE_ANY_ANC==1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(LEP_IGG_POSITIVE_ANY_ANC==1, na.rm = TRUE)/sum(EXPANSION_ENROLL == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
near_miss_tabb <- near_miss %>% 
 ...
 "Any potentially life-threatening condition" = paste0(
    ...
    "Pre-eclampsia without severe features " = paste0(
      format(sum(PREECLAMPSIA==1 & NEARMISS_DENOM == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(PREECLAMPSIA==1 & NEARMISS_DENOM == 1, na.rm = TRUE)/sum(NEARMISS_DENOM == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
|--------- | ----|---------|
|1st| 0.6-3.4 µIU/mL | 0.8-1.2 ng/dL |
|2nd| 0.37 - 3.6 µIU/mL | 0.6-1.0 ng/dL |
|3rd| 0.38-4.04 µIU/mL | 0.5-0.8 ng/dL |
...
|Euthyroid| normal | not considered |
