---
title: "<span style='font-size: 18px'> <span style='text-align: center'> PRISMA-Maternal-Outcomes (Issued: 2024 October 22)"
output:
  pdf_document:
    toc: no
    toc_depth: 6
...
#* Last updated: October 22 2024, Erin Oakley, Savannah O'Malley & Stacie Loisate
#*****************************************************************************
library(knitr)
library(tidyverse)
library(reshape2)
...
**Denominator:** Pregnancies ending in a livebirth or stillbirth (>=20 weeks GA). 
...
induced_tab_output <- tb_theme1(induced_tab) %>% 
  ...
  tab_row_group(
    label = html("<span style='font-size: 18px'>Induced labor prevalence</span>"),
    rows = 7:9
  ) %>%
    # bold denominator rows 1
  tab_style(
...
tab_style(
      ...
      locations = cells_stub(rows = c(
                 ...
                 "Expected denominator (total completed pregnancies)"))) %>% 
 row_group_order(groups = c("<span style='font-size: 18px'>Data completeness <sup>a</sup></span>",
                           "<span style='font-size: 18px'>Induced labor prevalence</span>"))  %>% 
