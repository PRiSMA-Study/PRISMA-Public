---
title: "<span style='font-size: 18px'> <span style='text-align: center'> PRISMA-Maternal-Outcomes (Issued: 2024 July 5)"
output:
  pdf_document:
    toc: no
    toc_depth: 6
...
depression_complete_tab <- depression %>%
  ...
  summarise(
    ...
    "Visit not completed^b^, n (%)" = paste0(
      ...
      " (",
      format(round(sum(DEPR_ANC20_MISS== -2, na.rm = TRUE)/sum(PC_ANCLESS20_DENOM == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

    "Visit completed but no summary score, n (%)" = paste0(
      format(sum(DEPR_ANC20_MISS==-1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DEPR_ANC20_MISS==-1, na.rm = TRUE)/sum(PC_ANCLESS20_DENOM == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    "Visit not completed^b^, n (%) " = paste0(
      ...
      " (",
      format(round(sum(DEPR_ANC32_MISS== -2, na.rm = TRUE)/sum(PC_ANCOVER31_DENOM== 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

    "Visit completed but no summary score, n (%) " = paste0(
      format(sum(DEPR_ANC32_MISS==-1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DEPR_ANC32_MISS==-1, na.rm = TRUE)/sum(PC_ANCOVER31_DENOM== 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    "Visit not completed^b^, n (%)  " = paste0(
      ...
      " (",
      format(round(sum(DEPR_PNC6_MISS== -2, na.rm = TRUE)/sum(PC_PNC6_DENOM== 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),

    "Visit completed but no summary score, n (%)  " = paste0(
      format(sum(DEPR_PNC6_MISS==-1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DEPR_PNC6_MISS==-1, na.rm = TRUE)/sum(PC_PNC6_DENOM== 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
...
tab_footnote(
    footnote = html("<span style='font-size: 18px'><sup>d</sup> ANC-32 includes depression assessments conducted at ANC-20 and ANC-36 per protocol.</span>")
 )  
...
overt_diabetes <- gdm %>% 
  ...
  summarise(
    ...
    "No overt diabetes (<6.5% HbA1c)" = paste0(
      format(sum(DIAB_OVERT==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT_MISS==0, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DIAB_OVERT==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT_MISS==0, na.rm = TRUE)/sum(COMPLETE_ANC28 == 1 & DIAB_OVERT_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Overt diabetes (>=6.5% HbA1c or previous diagnosis)" = paste0(
      format(sum(DIAB_OVERT==1 & COMPLETE_ANC28 == 1 & DIAB_OVERT_MISS==0, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DIAB_OVERT==1 & COMPLETE_ANC28 == 1 & DIAB_OVERT_MISS==0, na.rm = TRUE)/sum(COMPLETE_ANC28 == 1 & DIAB_OVERT_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")")
...
pretest_fast_diabetes <- gdm %>% 
  ...
  summarise(
    ...
    "Denominator (non-missing)" = paste0(
      format(sum(DIAB_GEST_FASTING_MISS==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1, na.rm = TRUE), nsmall = 0, digits = 2)),
    
    "No gestational diabetes(<5.1 mmol/L)" = paste0(
      format(sum(DIAB_GEST_FASTING==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_FASTING_MISS==0, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DIAB_GEST_FASTING==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_FASTING_MISS==0, na.rm = TRUE)/sum(COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_FASTING_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Gestational diabetes (>=5.1 mmol/L)" = paste0(
      format(sum(DIAB_GEST_FASTING==1 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_FASTING_MISS==0, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DIAB_GEST_FASTING==1 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_FASTING_MISS==0, na.rm = TRUE)/sum(COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_FASTING_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")")
...
ogtt_diabetes <- gdm %>% 
  ...
  summarise(
    ...
    "Denominator (non-missing)" = paste0(
      format(sum(DIAB_GEST_1HR_MISS==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1, na.rm = TRUE), nsmall = 0, digits = 2)),
    
    "No gestational diabetes (<10.0 mmol/L)" = paste0(
      format(sum(DIAB_GEST_1HR==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_1HR_MISS==0, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DIAB_GEST_1HR==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_1HR_MISS==0, na.rm = TRUE)/sum(COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_1HR_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Gestational diabetes (>=10.0 mmol/L)" = paste0(
      format(sum(DIAB_GEST_1HR==1 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_1HR_MISS==0, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DIAB_GEST_1HR==1 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_1HR_MISS==0, na.rm = TRUE)/sum(COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_1HR_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")")
...
ogtt2_diabetes <- gdm %>% 
  ...
  summarise(
   ...
   "Expected denominator (pregnancies continued to 28 weeks gestation)" = paste0(
    ...
    "Denominator (non-missing)" = paste0(
      format(sum(DIAB_GEST_2HR_MISS==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1, na.rm = TRUE), nsmall = 0, digits = 2)),
    
    "No gestational diabetes (<8.5 mmol/L)" = paste0(
      format(sum(DIAB_GEST_2HR==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_2HR_MISS==0, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DIAB_GEST_2HR==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_2HR_MISS==0, na.rm = TRUE)/sum(COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_2HR_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    
    "Gestational diabetes (>=8.5 mmol/L)" = paste0(
      format(sum(DIAB_GEST_2HR==1 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_2HR_MISS==0, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DIAB_GEST_2HR==1 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_2HR_MISS==0, na.rm = TRUE)/sum(COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_2HR_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")")
...
any_test_diabetes <- gdm %>% 
  ...
  summarise(
   ...
   "Expected denominator (pregnancies continued to 28 weeks gestation)" = paste0(
    ...
    "Missing ANC-28  lab form (MNH08) and no blood glucose test at other visits" = paste0(
      format(sum(DIAB_GEST_ANY_MISS==2 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DIAB_GEST_ANY_MISS==2 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1, na.rm = TRUE)/sum(COMPLETE_ANC28 == 1 & DIAB_OVERT != 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
    ...
    "Denominator (non-missing)" = paste0(
      format(sum(DIAB_GEST_ANY_MISS==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1, na.rm = TRUE), nsmall = 0, digits = 2)),
    
    "No gestational diabetes (across all 3 tests)" = paste0(
      format(sum(DIAB_GEST_ANY==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_ANY_MISS==0, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(DIAB_GEST_ANY==0 & COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_ANY_MISS==0, na.rm = TRUE)/sum(COMPLETE_ANC28 == 1 & DIAB_OVERT != 1 & DIAB_GEST_ANY_MISS==0, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
