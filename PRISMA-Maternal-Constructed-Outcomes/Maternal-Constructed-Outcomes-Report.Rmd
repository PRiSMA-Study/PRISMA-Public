...
#thy<- read_dta(paste0(path_to_data, "thyr_collapsed.dta"))  %>% rename_all(toupper) %>% filter(SITE != "")
#hdp <- read_dta(paste0(path_to_data, "HDPs.dta"))  %>% rename_all(toupper) %>% filter(SITE != "")
...
**Numerator:** Valid depression score >= site-specific cutoff (calculated from variables `EPDS0101` – `EPDS0110` [MNH25]) AND visit type = i (`TYPE_VISIT` [MNH25])
  ...
  summarise(
   ...
   "Severe abortion complications" = paste0(
    ...
    "Pulmonary edema" = paste0(
       format(sum(PULM_EDEMA_M19 == 1 & NEAR_MISS_DENOM == 1, na.rm = TRUE), nsmall = 0, digits = 2),
       " (",
       format(round(sum(PULM_EDEMA_M19 == 1 & NEAR_MISS_DENOM == 1, na.rm = TRUE)/sum(NEAR_MISS_DENOM == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"), 
...
near_miss_tabb <- near_miss %>% 
  ...
  summarise(      
    ...
    "Laparotomy other than C-section (M19)" = paste0(
      format(sum(LAPAROTOMY_M19==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE), nsmall = 0, digits = 2),
      " (",
      format(round(sum(LAPAROTOMY_M19==1 & NEAR_MISS_DENOM == 1, na.rm = TRUE)/sum(NEAR_MISS_DENOM == 1, na.rm=TRUE)*100, 2), nsmall = 0, digits = 2),
      ")"),
   ...
   "Uterine rupture" = paste0(
    ...
    "Met any near miss criteria" = paste0(
...
thy_tab <- thy %>% 
  ...
  summarise(
     ...
     "Expected number at ANC20" = paste0(
    ...
    "Denominator at ANC20 (non-missing)" = paste0(
      format(sum(THYR_ANC20_DENOM == 1, na.rm = TRUE), nsmall = 0, digits = 2)),
     
     "Euthyroid at ANC20" = paste0(
     ...
     "Overt hyperthyroidism at ANC20" = paste0(
     ...
     "Subclinical hyperthyroidism at ANC20" = paste0(
     ...
     "Overt hypothyroidism at ANC20" = paste0(
     ...
     "Subclinical hypothyroidism at ANC20" = paste0(
...
thy_tab32 <- thy %>% 
  ...
  summarise(
    ...
    "Denominator at ANC32 (non-missing)" = paste0(
     ...
     "Overt hyperthyroidism at ANC32" = paste0(
     ...
     "Subclinical hyperthyroidism at ANC32" = paste0(
     ...
     "Overt hypothyroidism at ANC32" = paste0(
     ...
     "Subclinical hypothyroidism at ANC32" = paste0(
